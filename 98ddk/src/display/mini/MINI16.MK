...
MYRC = $(BASEDIR)\bin\win98\bin16\rc


ASMENV		= ML
MYCC        = $(C16_ROOT)\bin\cl
...
INCLUDE = $(INCLUDE);$(INC16)
INCLUDE = $(INCLUDE);$(INC32)
INCLUDE = $(INCLUDE);$(C16_ROOT)\Include
...
!else
CFLAGS = /Alfw /nologo /GD /W3 /c /Zp /Zi /G3s /u /Oxat -NT _TEXT $(DEF) $(DEF16) $(COPT) -DWIN95 -DBUILD_DDDDK -DMSBUILD=1
!endif

!ifdef OVERRIDE_A16FLAGS
AFLAGS = $(OVERRIDE_A16FLAGS)
!else
AFLAGS   = /D?QUIET /nologo /c /Zi /Zd /Zm /Cp -DMSBUILD=1 $(DEF)
!endif
