...
DRVLIBS = $(DRVLIBS32) kernel32.lib user32.lib advapi32.lib \
          ddraw.lib dxguid.lib thunk32.lib winmm.lib libc.lib
...
<<
        $(MYMAPSYM) $(DRVMAP)
        if not $(DRVSYM)==$(DRVSYM2) del $(DRVSYM2)
        if exist $(DRVSYM) rename $(DRVSYM) $(DRVSYM2)
!if "$(VERDIR)" == "debug32"
