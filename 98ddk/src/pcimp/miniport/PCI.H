...
typedef PCIMPRET	(_cdecl *PPCIMPGARTRESERVE)(PVOID pHandle, PVOID pRefData, ULONG ulNumPages, ULONG ulAlignMask, PVOID *ppMapHandle, PULONG pulGARTDev, ULONG ulFlags);
