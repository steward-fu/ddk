...
//
// BUGBUG BUGBUG BUGBUG BUGBUG BUGBUG
//
// For now, hid class can only deal with hardware and device IDS starting
// with the string "USB\\"  this needs to be resolved, but for now...
//
// BUGBUG BUGBUG BUGBUG BUGBUG BUGBUG
//
// #define GAME_HARDWARE_IDS L"Game\\XYZPDQ_1234\0"
