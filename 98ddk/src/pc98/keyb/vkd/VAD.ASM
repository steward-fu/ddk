...
;   --------  --------  -------------------------------------------------------
;   09-05-87  Original	Rewrote to virtualize BIOS instead of hardware
;   10-07-87  2.01	Prevents nested interrupts & times out ints
;   17-Jan-1989 RAL	Version 3.0 -- Interfaced to VAD
;   10-Apr-1989 RAL	Removed anoying Trace_Outs
;   06-Jun-1989 RAL	Tell VMD that PS/2 type mouse exists if VMD is around
;   04-Aug-1989 RAL	Throw away data 3 bytes at a time if queue overflows
;   20-Oct-1989 FJ      Throw away entire packets only.
;                       Removed Time-Out routine (added time-out on IRET).
;   12-Dec-1989 RAL	Made IRQ shareable, hooks Int 15h vector in PMode
;   13-Dec-1989 RAL	Fix for IRQ request transfer
;   28-Nov-1990 RAL	Support for ballpoint
;
;==============================================================================
;
