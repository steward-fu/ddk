...
!ifdef OMB
LIBNDIS         =       $(LIBDIR)\$(BINTYPE)\libndis.lib
LIBVXD          =       $(DDKROOT)\lib\i386\free\vxdwraps.lib
LINK            =       link386.exe
!else
LIBNDIS         =       $(LIBDIR)\$(BINTYPE)\libndis.clb
...
CFLAGS  = -nologo -W2 -Zp -Gs -DIS_32 -Zl -c -Oy- -Ox
AFLAGS  = -DIS_32 -nologo -W2 -Zm -Cx -DMASM6 -DVMMSYS -Zm -DMAC=$(DEVICE)
