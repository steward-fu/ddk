...
Abstract:
    ...
    SONIC Ethernet controller.  This driver conforms to the NDIS 3.0/3.1
    interface.
...

{
    ...
    if (Adapter->FirstRequest != (PNDIS_REQUEST)NULL) {
        ...
        if (!Adapter->RequestInProgress) {
            Status =SonicProcessRequestQueue(Adapter);
        }
...

{
    ...
    static const UCHAR InternalDescriptor[] = "NEC B4680 Ethernet Adapter ";
