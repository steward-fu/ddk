...
#include "setup4.h"	/////BP This is still a test/////
#include "serialui.h"
#include "res.h"


#define	BSM_APPLICATIONS	0x00000008	/////BP trying this/////
#define BSF_NOHANG		0x00000008	/////BP trying this/////
...
void PRIVATE DumpDCB(
    ...
    if (IsFlagSet(g_uDumpFlags, DF_DCB))
        {
        int i;
