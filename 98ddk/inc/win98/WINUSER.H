...
#ifndef WINVER
#define WINVER  0x040A          /* version 4.1 */
#endif /* !WINVER */

#ifndef _WIN32_WINDOWS
#define _WIN32_WINDOWS  0x040A  /* version 4.1 */
...
#define HBMMENU_BULLET           ((HBITMAP)  4)
...
typedef struct tagMENUITEMINFOA
{
    ...
    LPSTR   dwTypeData;     // used if MIIM_STRING
    UINT    cch;            // used if MIIM_STRING
#if(_WIN32_WINDOWS >= 0x040a)
...
typedef struct tagMENUITEMINFOW
{
    ...
    HBITMAP hbmpUnchecked;  // used if MIIM_CHECKMARKS
    DWORD   dwItemData;     // used if MIIM_DATA
    LPWSTR  dwTypeData;     // used if MIIM_STRING
    UINT    cch;            // used if MIIM_STRING
#if(_WIN32_WINDOWS >= 0x040a)
    HBITMAP hbmpItem;       // used if MIIM_BITMAP
#endif /* _WIN32_WINDOWS >= 0x040a */
...
#if(_WIN32_WINDOWS >= 0x040a)
#define DCX_MONITOR          0x00004000L
#endif /* _WIN32_WINDOWS >= 0x040a */
...
#define MF_STRING           0x00000000L /* Obsolete -- use MIIM_STRING instead */
#define MF_BITMAP           0x00000004L /* Obsolete -- use MIIM_BITMAP instead */
...
#define MFT_BITMAP          MF_BITMAP   /* Obsolete -- use MIIM_BITMAP instead */
...
// VIDEOPARAMETERS structure moved to tvout.h
...
WINUSERAPI HWINEVENTHOOK WINAPI
SetWinEventHook(
    DWORD        eventMin,
    DWORD        eventMax,
...
#define STATE_SYSTEM_VALID              0x03FFFFFF
