...
#else   //USE_MIRRORING 
#define NOMIRRORBITMAP      (DWORD)0x00000000 /* Not used*/
#endif  //USE_MIRRORING 
#endif /* WINVER >= 0x040a */
...
WINGDIAPI BOOL  WINAPI TransparentImage(HDC,int,int,int,int,HDC,int,int,int,int,UINT,UINT);

WINGDIAPI BOOL  WINAPI TransparentDIBImage(HDC,int,int,int,int,CONST VOID *,
        CONST BITMAPINFO *,UINT,int,int,int,int,UINT,UINT);
...
WINGDIAPI BOOL  WINAPI GradientFill(HDC,PTRIVERTEX,ULONG,PUSHORT,ULONG,ULONG);
