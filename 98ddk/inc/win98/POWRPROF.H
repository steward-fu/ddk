...
BOOLEAN  GetAlarmRunPrograms(LPTSTR, UINT, LPTSTR, UINT);
BOOLEAN  SetAlarmRunPrograms(LPCTSTR, LPCTSTR);
...
#ifdef DEBUG
void DumpPowerActionPolicy(UINT, LPTSTR, PPOWER_ACTION_POLICY);
void DumpSystemPowerLevel(UINT, LPTSTR, PSYSTEM_POWER_LEVEL);
void DumpSystemPowerPolicy(UINT, LPTSTR, PSYSTEM_POWER_POLICY);
void DumpSystemPowerCapabilities(UINT, LPTSTR, PSYSTEM_POWER_CAPABILITIES);
void DifSystemPowerPolicies(UINT, LPTSTR, PSYSTEM_POWER_POLICY, PSYSTEM_POWER_POLICY);
#endif
