...
//
#define ACODE_STATUS_MASK                       ((NTSTATUS)0xC8088070L)
...
//
#define RCODE_STATUS_MASK                       ((NTSTATUS)0xC8088080L)
#define STATUS_INVALID_GENERATION               ((NTSTATUS)0xC8088090L)
...
#define MODULE_VENDOR_ID_KEY_SIGNITURE          0x03
#define NODE_CAPABILITIES_KEY_SIGNITURE         0x0c
#define SPEC_ID_KEY_SIGNITURE                   0x12
#define SOFTWARE_VERSION_KEY_SIGNITURE          0x13
#define COMMAND_BASE_KEY_SIGNITURE              0x40
#define VENDOR_KEY_SIGNITURE                    0x81    
#define MODEL_KEY_SIGNITURE                     0x82
#define UNIT_DIRECTORY_KEY_SIGNITURE            0xd1
#define UNIT_DEP_DIR_KEY_SIGNITURE              0xd4
...
#define CONFIG_ROM_SIGNITURE                    0x31333934
...
#define IRB_BUS_RESERVED_SZ                     16
#define IRB_PORT_RESERVED_SZ                    16
...
typedef struct _IRB {
    ...
    union {
        ...
        // The topology map is in big endian
        //
...
//
// Specifies port driver has no special capabilities.  This is the stupidest
// of all drivers.  "Stupid is as stupid does"...
//
