...
typedef struct _VTC_INFO {
VOID (_cdecl *pAcpiIdleHandler)(VOID);
VOID (_cdecl *pSetSystemPowerStateHandler)(SYSTEM_POWER_STATE PowerState);
}   VTC_INFO, *PVTC_INFO;
