...
VPICD_Service	(_VPICD_Get_Level_Mask, VXD_LOCKED_CODE)	// Obsolete
VPICD_Service	(_VPICD_Set_Level_Mask, VXD_LOCKED_CODE)	// Obsolete
...
VOID static __inline
_VPICD_Get_Level_Mask(VOID)
{
    VxDCall(_VPICD_Get_Level_Mask)
}

VOID static __inline
_VPICD_Set_Level_Mask(WORD wIRQMask)
{
    _asm push   wIRQMask
    VxDCall(_VPICD_Set_Level_Mask)
    _asm add    esp, 4
}
