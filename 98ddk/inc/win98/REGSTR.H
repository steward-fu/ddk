...
//
// Entries under VCOMM devnodes
//

#define REGSTR_VAL_DISABLE_PM		"DisablePowerManagement"
...
#define REGSTR_VAL_FLOPPYFASTBOOT "FloppyFastBoot"
...
#define REGSTR_VAL_FASTBOOT     "FloppyFastBoot"
...
#define CONFIGFLAG_CANGOAWAY        0x00000400  // Device not fixed to portable.
#define CONFIGFLAG_MANUAL_DRIVER    0x00000800  // Driver selected manually by user.
#define CONFIGFLAG_NOUPDATECANGOAWAY    0x00001000  // Do not update CANGOAWAY flag automatically.
#define CONFIGFLAG_NODISCARDBOOT    0x00002000  // Don't discard boot_log_conf even if told to.
#define CONFIGFLAG_NOBROADCAST		0x00004000  // Don't do shell messages
#define CONFIGFLAG_NOPOWERMGMT      0x00008000  // No system power management when this device is present.
#define CONFIGFLAG_NOWAKEUP         0x00010000  // No wake up
...
#define REGSTR_VAL_CBSS_CSSAVE  "CBSSCSContextRanges"
#define REGSTR_VAL_CBSS_CBSAVE  "CBSSCBContextRanges"
#define REGSTR_VAL_CBSS_EXCASAVE "CBSSEXCAContextRanges"
