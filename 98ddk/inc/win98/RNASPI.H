...
#define SMMCFG_ALL                  0x00000717  // All the user-specified options
...
//
// MAC driver Net instance, HKLM\System\CurrentControlSet\Class\Net\XXXX 
//

#define MAC_INSTANCE_KEY_LENGTH	48   
...
typedef struct tagMAC_OPEN {
    ...
    enum {                               // All different types of device drivers
                    ...
                    VPN_DEVICE      	 // Virtual Private Network Devices.
...
#ifdef MULTI_ADAPTER_ENABLED
    //
    // The following fields are only in Memphis or later
    //

    CHAR            szEntryName [ RAS_MaxEntryName + 1 ];  // The name of the connection
    CHAR            MacInstance [ MAC_INSTANCE_KEY_LENGTH + 1 ];  // The MAC driver instance
#endif
