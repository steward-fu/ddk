...
//              VCFB_Tag - (dl) contains one or more TAGBLOCK flags (see below)
//
//	Entry	(al) = options
...
#define VCFB_Tag                0x80

//  If VCFB_Tag is specified, then DL contains one or more of the following
//  TAGBLOCK flags, which indicate additional information associated with the
//  block.  All other bits are reserved for future FindBlock options and
//  must be zero.  This is nothing more than advisory information, and VCACHE
//  neither requires it nor is it obligated to use it.

#define TAGBLOCK_NONE           0x00    // unknown (or direct) I/O
#define TAGBLOCK_PATH           0x01    // ESI -> fully canonicalized pathname
#define TAGBLOCK_FILE           0x02    // ESI -> filename
#define TAGBLOCK_SRCH           0x04    // search request
#define TAGBLOCK_DIR            0x08    // directory block
#define TAGBLOCK_FAT            0x10    // FAT block
