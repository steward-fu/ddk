...
#define KSEVENTF_CALLBACK           0x00000040
#endif // defined(_NTDDK_)
...
typedef struct {
    ...
    ULONG       Frames;                 // total number of allowable outstanding frames
    ULONG       FileAlignment;
    ULONG       PhysicalMinFrameSize;           
    ULONG       PhysicalMaxFrameSize;
    ULONG       OptimalMinFrameSize;   
    ULONG       OptimalMaxFrameSize;
    struct {
        ULONG       RatioNumerator;      // compression/expansion ratio
        ULONG       RatioDenominator; 
        ULONG       RatioConstantMargin;
    } Output;
    KSPRIORITY  OptimalPriority;       
    ULONG       MemoryTypesCount;
    ULONG       Reserved;
    GUID        SupportedMemoryTypes[1]; // list of memory GUIDs         
...
#define KSMETHOD_TYPE_IRP_STORAGE(Irp)      ((UINT_PTR)((Irp)->Tail.Overlay.DriverContext[2]))
