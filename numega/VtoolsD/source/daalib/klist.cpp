// klist.cpp - core list class implementation
//=============================================================================
//
...
////////////////////////////////////////////////////////////////////////////////
_isafelist::_isafelist(KInterrupt* pInterruptObject, ULONG OffsetOfListEntry) :
	_listcore(OffsetOfListEntry),
	m_intobj(pInterruptObject)
{
}

_isafelist::_isafelist(ULONG OffsetOfListEntry) :
	_listcore(OffsetOfListEntry),
	m_intobj(NULL)
{
}
////////////////////////////////////////////////////////////////////////////////
VOID _isafelist::Initialize(KInterrupt* pInterruptObject)
{
	ASSERT(m_intobj == NULL);
	m_intobj = pInterruptObject;
}
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
BOOLEAN _isafelist::_synchFind(PVOID Context)
{
	va_list av			= *(va_list*)Context;
	_isafelist* pList	= va_arg(av, _isafelist*);
	PVOID Item			= va_arg(av, PVOID);
	PVOID StartItem		= va_arg(av, PVOID);
	BOOLEAN bForward	= va_arg(av, BOOLEAN);
	PVOID* pMatch		= va_arg(av, PVOID*);

	*pMatch = pList->_find(Item, StartItem, bForward);
	return TRUE;
}
////////////////////////////////////////////////////////////////////////////////
