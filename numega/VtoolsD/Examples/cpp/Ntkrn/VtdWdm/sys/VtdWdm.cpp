...
// Requires Compuware's Driver::Works classes
//
//
...
DECLARE_DRIVER_CLASS(VtdWdm, NULL)

/////////////////////////////////////////////////////////////////////
// Driver Entry (member of VtdWdm)
//
...
//						registry.  To locate VtdWdm look for:
//						HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\VtdWdm
//
// Output
...
NTSTATUS VtdWdm::DriverEntry(PUNICODE_STRING RegistryPath)
{
	t << "In DriverEntry\n";
	...
	{
		// Enable the following code to provide break on entry
#if 0
...
/////////////////////////////////////////////////////////////////////
// LoadRegistryParameters (member of VtdWdm)
//
//		Load driver data members from the registry.
// 
// Input
...
//		HKLM\SYSTEM\CurrentControlSet\Services\VtdWdm\Parameters\...

void VtdWdm::LoadRegistryParameters(KRegistryKey &Params)
{
...
NTSTATUS VtdWdm::AddDevice(PDEVICE_OBJECT Pdo)
{
	t << "AddDevice called\n";

    // Create the device object
	VtdWdmDevice * pDevice = new (NonPagedPool) VtdWdmDevice(Pdo, m_Unit);

	if (pDevice == NULL)
	{
		t << "Error creating device VtdWdmDevice"
			   << (ULONG) m_Unit << EOL;
	...
	{
		t << "Error constructing device VtdWdmDevice"
