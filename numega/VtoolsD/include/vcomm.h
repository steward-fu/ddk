...
; Modified by Compuware Corporation
;
; VCOMM.H
;
; Version:	1.00
...
/*MACROS*/
Begin_Service_Table(VCOMM)

VCOMM_Service	(VCOMM_Get_Version)
VCOMM_Service	(_VCOMM_Register_Port_Driver)
VCOMM_Service	(_VCOMM_Acquire_Port)
VCOMM_Service	(_VCOMM_Release_Port)
VCOMM_Service	(_VCOMM_OpenComm)
VCOMM_Service	(_VCOMM_SetCommState)
VCOMM_Service	(_VCOMM_GetCommState)
VCOMM_Service	(_VCOMM_SetupComm)
VCOMM_Service	(_VCOMM_TransmitCommChar)
VCOMM_Service	(_VCOMM_CloseComm)
VCOMM_Service	(_VCOMM_GetCommQueueStatus)
VCOMM_Service	(_VCOMM_ClearCommError)
VCOMM_Service	(_VCOMM_GetModemStatus)
VCOMM_Service	(_VCOMM_GetCommProperties)
VCOMM_Service	(_VCOMM_EscapeCommFunction)
VCOMM_Service	(_VCOMM_PurgeComm)
VCOMM_Service	(_VCOMM_SetCommEventMask)
VCOMM_Service	(_VCOMM_GetCommEventMask)
VCOMM_Service	(_VCOMM_WriteComm)
VCOMM_Service	(_VCOMM_ReadComm)
VCOMM_Service	(_VCOMM_EnableCommNotification)
VCOMM_Service	(_VCOMM_GetLastError)

VCOMM_Service	(_VCOMM_Steal_Port)

VCOMM_Service	(_VCOMM_SetReadCallBack)
VCOMM_Service	(_VCOMM_SetWriteCallBack)

VCOMM_Service	(_VCOMM_Add_Port)

/*ENDMACROS*/
#ifndef		WIN31COMPAT
/*MACROS*/

VCOMM_Service	(_VCOMM_GetSetCommTimeouts)
VCOMM_Service	(_VCOMM_SetWriteRequest)
VCOMM_Service	(_VCOMM_SetReadRequest)
VCOMM_Service	(_VCOMM_Dequeue_Request)

VCOMM_Service	(_VCOMM_Enumerate_DevNodes)

VCOMM_Service	(VCOMM_Map_Win32DCB_To_Ring0)
VCOMM_Service	(VCOMM_Map_Ring0DCB_To_Win32)

VCOMM_Service	(_VCOMM_Get_Contention_Handler)
VCOMM_Service	(_VCOMM_Map_Name_To_Resource)
/*ENDMACROS*/
#endif
/*MACROS*/
...
typedef IOCTLNOTIFICATIONFUNC(IOCtlBlock*, struct _OVERLAPPED*, DWORD, DWORD);		// Compuware
typedef IOCTLNOTIFICATIONFUNC* PIOCTLNOTIFICATIONFUNC;
...
struct _Win32DCB		// Compuware (from vcomm32.inc)
{
	DWORD W32DCBLength;	// size of DCB
	DWORD W32BaudRate;	// baud rate at which port is working
	DWORD W32BitMask;	// misc flags
	WORD W32Reserved;	// reserved stuff
	WORD W32XonLim;		// Xmit X-ON threshold
	WORD W32XoffLim;	// Xmit X-OFF threshold
	BYTE W32ByteSize;	// size of byte
	BYTE W32Parity;		// parity
	BYTE W32StopBits;	
	BYTE W32XonChar;
	BYTE W32XoffChar;	
	BYTE W32ErrorChar;	
...
typedef struct _Win32DCB WIN32DCB, *PWIN32DCB;	// Compuware


typedef struct _COMM_CONFIG	// Compuware
{
	DWORD	cc_dwSize;
	WORD	cc_wVersion;
	WORD	cc_wAlignDCB;
	WIN32DCB cc_dcb;
	DWORD   cc_dwProviderSubType;
	PVOID	cc_dwProviderOffset;
	DWORD	cc_dwProviderSize;
	WCHAR	cc_wcProviderData[1];
