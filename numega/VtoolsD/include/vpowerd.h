...
/*MACROS*/
Begin_Service_Table(VPOWERD)

    VPOWERD_Service     (_VPOWERD_Get_Version)
    VPOWERD_Service     (_VPOWERD_Get_APM_BIOS_Version)
    VPOWERD_Service     (_VPOWERD_Get_Power_Management_Level)
    VPOWERD_Service     (_VPOWERD_Set_Power_Management_Level)
    VPOWERD_Service     (_VPOWERD_Set_Device_Power_State)
    VPOWERD_Service     (_VPOWERD_Set_System_Power_State)
    VPOWERD_Service     (_VPOWERD_Restore_Power_On_Defaults)
    VPOWERD_Service     (_VPOWERD_Get_Power_Status)
    VPOWERD_Service     (_VPOWERD_Get_Power_State)
    VPOWERD_Service     (_VPOWERD_OEM_APM_Function)
    VPOWERD_Service     (_VPOWERD_Register_Power_Handler)
    VPOWERD_Service     (_VPOWERD_Deregister_Power_Handler)
    VPOWERD_Service     (_VPOWERD_W32_Get_System_Power_Status)
    VPOWERD_Service     (_VPOWERD_W32_Set_System_Power_State)

End_Service_Table(VPOWERD)
/*ENDMACROS*/
