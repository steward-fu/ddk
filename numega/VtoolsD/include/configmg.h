...
// Macro DeclareMemResource is required to support Borland C++, which does 
// not have the feature of zero length arrays at the end of structures. The
// integer parameter to the macro is the size to declare the array. Note that
// for Microsoft, the new delcared type is identical to the original type.

#ifdef _MSC_VER
#define DeclareMemResource(n) typedef MEM_RESOUCE MEM_RESOURE##n
#endif //_MSC_VER

#ifdef __BORLANDC__
#define DeclareMemResource(n) 			\
typedef struct	MEM_Resource_s##n {		\
	MEM_DES			MEM_Header;	\
	MEM_RANGE		MEM_Data[n];	\
} MEM_RESOUCE##n;
#endif	//__BORLANDC__
...
// Macro DeclareIOResource is required to support Borland C++, which does 
// not have the feature of zero length arrays at the end of structures. The
// integer parameter to the macro is the size to declare the array. Note that
// for Microsoft, the new delcared type is identical to the original type.

#ifdef _MSC_VER
#define DeclareIOResource(n) typedef IO_RESOURCE IO_RESOURCE##n
#endif //_MSC_VER

#ifdef __BORLANDC__
#define DeclareIOResource(n) 			\
typedef struct	IO_Resource_s##n {		\
	IO_DES			IO_Header;	\
	IO_RANGE		IO_Data[n];	\
} IO_RESOURCE##n;
#endif //__BORLANDC__
...
/*MACROS*/
Begin_Service_Table(CONFIGMG)
CONFIGMG_Service	(_CONFIGMG_Get_Version)
CONFIGMG_Service	(_CONFIGMG_Initialize)
CONFIGMG_Service	(_CONFIGMG_Locate_DevNode)
CONFIGMG_Service	(_CONFIGMG_Get_Parent)
CONFIGMG_Service	(_CONFIGMG_Get_Child)
CONFIGMG_Service	(_CONFIGMG_Get_Sibling)
CONFIGMG_Service	(_CONFIGMG_Get_Device_ID_Size)
CONFIGMG_Service	(_CONFIGMG_Get_Device_ID)
CONFIGMG_Service	(_CONFIGMG_Get_Depth)
CONFIGMG_Service	(_CONFIGMG_Get_Private_DWord)
CONFIGMG_Service	(_CONFIGMG_Set_Private_DWord)
CONFIGMG_Service	(_CONFIGMG_Create_DevNode)
CONFIGMG_Service	(_CONFIGMG_Query_Remove_SubTree)
CONFIGMG_Service	(_CONFIGMG_Remove_SubTree)
CONFIGMG_Service	(_CONFIGMG_Register_Device_Driver)
CONFIGMG_Service	(_CONFIGMG_Register_Enumerator)
CONFIGMG_Service	(_CONFIGMG_Register_Arbitrator)
CONFIGMG_Service	(_CONFIGMG_Deregister_Arbitrator)
CONFIGMG_Service	(_CONFIGMG_Query_Arbitrator_Free_Size)
CONFIGMG_Service	(_CONFIGMG_Query_Arbitrator_Free_Data)
CONFIGMG_Service	(_CONFIGMG_Sort_NodeList)
CONFIGMG_Service	(_CONFIGMG_Yield)
CONFIGMG_Service	(_CONFIGMG_Lock)
CONFIGMG_Service	(_CONFIGMG_Unlock)
CONFIGMG_Service	(_CONFIGMG_Add_Empty_Log_Conf)
CONFIGMG_Service	(_CONFIGMG_Free_Log_Conf)
CONFIGMG_Service	(_CONFIGMG_Get_First_Log_Conf)
CONFIGMG_Service	(_CONFIGMG_Get_Next_Log_Conf)
CONFIGMG_Service	(_CONFIGMG_Add_Res_Des)
CONFIGMG_Service	(_CONFIGMG_Modify_Res_Des)
CONFIGMG_Service	(_CONFIGMG_Free_Res_Des)
CONFIGMG_Service	(_CONFIGMG_Get_Next_Res_Des)
CONFIGMG_Service	(_CONFIGMG_Get_Performance_Info)
CONFIGMG_Service	(_CONFIGMG_Get_Res_Des_Data_Size)
CONFIGMG_Service	(_CONFIGMG_Get_Res_Des_Data)
CONFIGMG_Service	(_CONFIGMG_Process_Events_Now)
CONFIGMG_Service	(_CONFIGMG_Create_Range_List)
CONFIGMG_Service	(_CONFIGMG_Add_Range)
CONFIGMG_Service	(_CONFIGMG_Delete_Range)
CONFIGMG_Service	(_CONFIGMG_Test_Range_Available)
CONFIGMG_Service	(_CONFIGMG_Dup_Range_List)
CONFIGMG_Service	(_CONFIGMG_Free_Range_List)
CONFIGMG_Service	(_CONFIGMG_Invert_Range_List)
CONFIGMG_Service	(_CONFIGMG_Intersect_Range_List)
CONFIGMG_Service	(_CONFIGMG_First_Range)
CONFIGMG_Service	(_CONFIGMG_Next_Range)
CONFIGMG_Service	(_CONFIGMG_Dump_Range_List)
CONFIGMG_Service	(_CONFIGMG_Load_DLVxDs)
CONFIGMG_Service	(_CONFIGMG_Get_DDBs)
CONFIGMG_Service	(_CONFIGMG_Get_CRC_CheckSum)
CONFIGMG_Service	(_CONFIGMG_Register_DevLoader)
CONFIGMG_Service	(_CONFIGMG_Reenumerate_DevNode)
CONFIGMG_Service	(_CONFIGMG_Setup_DevNode)
CONFIGMG_Service	(_CONFIGMG_Reset_Children_Marks)
CONFIGMG_Service	(_CONFIGMG_Get_DevNode_Status)
CONFIGMG_Service	(_CONFIGMG_Remove_Unmarked_Children)
CONFIGMG_Service	(_CONFIGMG_ISAPNP_To_CM)
CONFIGMG_Service	(_CONFIGMG_CallBack_Device_Driver)
CONFIGMG_Service	(_CONFIGMG_CallBack_Enumerator)
CONFIGMG_Service	(_CONFIGMG_Get_Alloc_Log_Conf)
CONFIGMG_Service	(_CONFIGMG_Get_DevNode_Key_Size)
CONFIGMG_Service	(_CONFIGMG_Get_DevNode_Key)
CONFIGMG_Service	(_CONFIGMG_Read_Registry_Value)
CONFIGMG_Service	(_CONFIGMG_Write_Registry_Value)
CONFIGMG_Service	(_CONFIGMG_Disable_DevNode)
CONFIGMG_Service	(_CONFIGMG_Enable_DevNode)
CONFIGMG_Service	(_CONFIGMG_Move_DevNode)
CONFIGMG_Service	(_CONFIGMG_Set_Bus_Info)
CONFIGMG_Service	(_CONFIGMG_Get_Bus_Info)
CONFIGMG_Service	(_CONFIGMG_Set_HW_Prof)
CONFIGMG_Service	(_CONFIGMG_Recompute_HW_Prof)
CONFIGMG_Service	(_CONFIGMG_Query_Change_HW_Prof)
CONFIGMG_Service	(_CONFIGMG_Get_Device_Driver_Private_DWord)
CONFIGMG_Service	(_CONFIGMG_Set_Device_Driver_Private_DWord)
CONFIGMG_Service	(_CONFIGMG_Get_HW_Prof_Flags)
CONFIGMG_Service	(_CONFIGMG_Set_HW_Prof_Flags)
CONFIGMG_Service	(_CONFIGMG_Read_Registry_Log_Confs)
CONFIGMG_Service	(_CONFIGMG_Run_Detection)
CONFIGMG_Service	(_CONFIGMG_Call_At_Appy_Time)
CONFIGMG_Service	(_CONFIGMG_Fail_Change_HW_Prof)
CONFIGMG_Service	(_CONFIGMG_Set_Private_Problem)
CONFIGMG_Service	(_CONFIGMG_Debug_DevNode)
CONFIGMG_Service	(_CONFIGMG_Get_Hardware_Profile_Info)
CONFIGMG_Service	(_CONFIGMG_Register_Enumerator_Function)
CONFIGMG_Service	(_CONFIGMG_Call_Enumerator_Function)
CONFIGMG_Service	(_CONFIGMG_Add_ID)
CONFIGMG_Service	(_CONFIGMG_Find_Range)
CONFIGMG_Service	(_CONFIGMG_Get_Global_State)
CONFIGMG_Service	(_CONFIGMG_Broadcast_Device_Change_Message)
CONFIGMG_Service	(_CONFIGMG_Call_DevNode_Handler)
CONFIGMG_Service	(_CONFIGMG_Remove_Reinsert_All)
//
// 4.0 OPK2 Services
//
CONFIGMG_Service	(_CONFIGMG_Change_DevNode_Status)
CONFIGMG_Service	(_CONFIGMG_Reprocess_DevNode)
CONFIGMG_Service	(_CONFIGMG_Assert_Structure)
CONFIGMG_Service	(_CONFIGMG_Discard_Boot_Log_Conf)
CONFIGMG_Service	(_CONFIGMG_Set_Dependent_DevNode)
CONFIGMG_Service	(_CONFIGMG_Get_Dependent_DevNode)
CONFIGMG_Service	(_CONFIGMG_Refilter_DevNode)
CONFIGMG_Service	(_CONFIGMG_Merge_Range_List)
CONFIGMG_Service	(_CONFIGMG_Substract_Range_List)
CONFIGMG_Service	(_CONFIGMG_Set_DevNode_PowerState)
CONFIGMG_Service	(_CONFIGMG_Get_DevNode_PowerState)
CONFIGMG_Service	(_CONFIGMG_Set_DevNode_PowerCapabilities)
CONFIGMG_Service	(_CONFIGMG_Get_DevNode_PowerCapabilities)
CONFIGMG_Service	(_CONFIGMG_Read_Range_List)
CONFIGMG_Service	(_CONFIGMG_Write_Range_List)
CONFIGMG_Service	(_CONFIGMG_Get_Set_Log_Conf_Priority)
CONFIGMG_Service	(_CONFIGMG_Support_Share_Irq)
CONFIGMG_Service	(_CONFIGMG_Get_Parent_Structure)
//
#ifdef	WIN410_OR_LATER
//
CONFIGMG_Service	(_CONFIGMG_Register_DevNode_For_Idle_Detection)
CONFIGMG_Service	(_CONFIGMG_CM_To_ISAPNP)
CONFIGMG_Service	(_CONFIGMG_Get_DevNode_Handler)
CONFIGMG_Service	(_CONFIGMG_Detect_Resource_Conflict)
CONFIGMG_Service	(_CONFIGMG_Get_Device_Interface_List)
CONFIGMG_Service	(_CONFIGMG_Get_Device_Interface_List_Size)
CONFIGMG_Service	(_CONFIGMG_Get_Conflict_Info)
CONFIGMG_Service	(_CONFIGMG_Add_Remove_DevNode_Property)
CONFIGMG_Service	(_CONFIGMG_CallBack_At_Appy_Time)
CONFIGMG_Service	(_CONFIGMG_Register_Device_Interface)
CONFIGMG_Service	(_CONFIGMG_System_Device_Power_State_Mapping)
CONFIGMG_Service	(_CONFIGMG_Get_Arbitrator_Info)
CONFIGMG_Service	(_CONFIGMG_Waking_Up_From_DevNode)
CONFIGMG_Service	(_CONFIGMG_Set_DevNode_Problem)
CONFIGMG_Service	(_CONFIGMG_Get_Device_Interface_Alias)
...
typedef	NODELISTHEADER 		*NODELIST_HEADER;
