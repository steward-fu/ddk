...
#define	ERROR_IO_PENDING		997	// Note: A VxD's W32_DEVICEIOCONTROL handler 
									//       returns -1 to signal I/O pending
// Note: Compuware Corporation has not verified that values marked by Microsoft with 
//       "BUGBUG" are accurate.
