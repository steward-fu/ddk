...
#else
#   define _STLP_ATOMIC_INCREMENT(__x)           NdisInterlockedIncrement((long*)__x)
#   define _STLP_ATOMIC_DECREMENT(__x)           NdisInterlockedDecrement((long*)__x)
#   define _STLP_ATOMIC_EXCHANGE(__x, __y)       InterlockedExchange((long*)__x, (long)__y)
#endif
#  endif
