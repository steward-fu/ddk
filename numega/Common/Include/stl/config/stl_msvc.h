...
# else
#  if (_MSC_VER < 1300)	
// For DDKs without compiler, like Win2000 DDK and below.
// It finds ctype.h in VC98\ATL\INCLUDE\..\..\include.
...
#  else
// For DDKs with compiler, starting from XP DDK. It finds ctype.h in CRT_INC_PATH\..\crt.
#  define _STLP_NATIVE_HEADER(x) <../crt/##x>
#  define _STLP_NATIVE_C_HEADER(x) <../crt/##x>
#  define _STLP_NATIVE_CPP_C_HEADER(x) <../crt/##x>
#  define _STLP_NATIVE_OLD_STREAMS_HEADER(x) <../crt/##x>
