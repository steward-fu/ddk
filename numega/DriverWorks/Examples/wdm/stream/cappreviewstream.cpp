// cappreviewstream.cpp - preview stream of Video Capture sample
//=============================================================================
//
...
const KS_DATARANGE_VIDEO_PALETTE VidcapPreviewStream::m_StreamFormatRGB8Bpp = 
{
    // KSDATARANGE
    {   
...
const KS_DATARANGE_VIDEO VidcapPreviewStream::m_StreamFormatRGB24Bpp_Preview = 
{
    // KSDATARANGE
    {   
...
const PKSDATAFORMAT VidcapPreviewStream::m_StreamFormats[] = 
{
    (PKSDATAFORMAT) &m_StreamFormatRGB24Bpp_Preview,
#ifdef USE_RGB8
...
// STREAM_Preview
// -----------------------------------------------------------------
const HW_STREAM_INFORMATION	VidcapPreviewStream::m_StreamInfo =
{
...
// Ctor						  
VidcapPreviewStream::VidcapPreviewStream(void) :
	VidcapBaseStream()
{
	#ifdef __VIDCAP_TRACEON__
	TVS << TraceInfo << "VidcapPreviewStream::VidcapPreviewStream -- contructed\n";
	#endif

}

// -- stream initialization --
void VidcapPreviewStream::InitializeStream()
{
	#ifdef __VIDCAP_TRACEON__
	TVS << TraceInfo << "VidcapPreviewStream::InitializeStream -- calling InitializeBaseClass\n";
	#endif
...
void VidcapPreviewStream::OnRead(PHW_STREAM_REQUEST_BLOCK pSrb)
{
    // Rule: 
	...
	#ifdef __VIDCAP_TRACEON__
	TVS << TraceInfo << "VidcapPreviewStream::OnRead -- Start\n";
	#endif
	...
	{
		#ifdef __VIDCAP_TRACEON__
		TVS << TraceAlways << "VidcapPreviewStream::OnRead -- KSSTATE_STOP... Can't accept read\n";
		#endif
	...
	#ifdef __VIDCAP_TRACEON__
	TVS << TraceInfo << "VidcapPreviewStream::OnRead -- End\n";
	#endif
}

/*
VOID VidcapPreviewStream::GetInformation(PHW_STREAM_INFORMATION pInfo)
{
