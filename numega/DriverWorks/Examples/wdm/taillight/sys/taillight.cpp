...
POOLTAG DefaultPoolTag('liaT');

// Create the global driver trace object
// TODO:	Use KTrace if you want trace messages
//			to appear only in debug builds.  Use KTrace if
//			you want trace messages to always appear.	
KDebugOnlyTrace t("TailLight");

/////////////////////////////////////////////////////////////////////
// Begin INIT section
#pragma code_seg("INIT")

DECLARE_DRIVER_CLASS(TailLight, NULL)
/////////////////////////////////////////////////////////////////////
//  TailLight::DriverEntry
//
//	Routine Description:
...
//			registry.  To locate TailLight look for:
//			HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\TailLight
//
//	Return Value:
...
NTSTATUS TailLight::DriverEntry(PUNICODE_STRING RegistryPath)
{
...
/////////////////////////////////////////////////////////////////////
//  TailLight::LoadRegistryParameters
//
//	Routine Description:
//		Load driver data members from the registry.
// 
...
//		HKLM\SYSTEM\CurrentControlSet\Services\TailLight\Parameters\...
//

void TailLight::LoadRegistryParameters(KRegistryKey &Params)
{
...
//
NTSTATUS TailLight::AddDevice(PDEVICE_OBJECT Pdo)
{
	t << "AddDevice called\n";
	...
	TailLightDevice * pDevice = new (
		...
		TailLightDevice(Pdo, m_Unit);

	if (pDevice == NULL)
	{
		t << "Error creating device TailLightDevice"
			   << (ULONG) m_Unit << EOL;
	...
	{
		t << "Error constructing device TailLightDevice"
