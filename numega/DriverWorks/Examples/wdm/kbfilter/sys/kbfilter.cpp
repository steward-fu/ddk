...
DECLARE_DRIVER_CLASS(Kbfilter, NULL)

/////////////////////////////////////////////////////////////////////
//  Kbfilter::DriverEntry
//
//	Routine Description:
...
//			registry.  To locate Kbfilter look for:
//			HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Kbfilter
//
//	Return Value:
...
NTSTATUS Kbfilter::DriverEntry(PUNICODE_STRING RegistryPath)
{
	t << "In DriverEntry\n";
...
/////////////////////////////////////////////////////////////////////
//  Kbfilter::LoadRegistryParameters
//
//	Routine Description:
//		Load driver data members from the registry.
// 
...
//		HKLM\SYSTEM\CurrentControlSet\Services\Kbfilter\Parameters\...
//

void Kbfilter::LoadRegistryParameters(KRegistryKey &Params)
{
...
NTSTATUS Kbfilter::AddDevice(PDEVICE_OBJECT Pdo)
{
	t << "AddDevice called\n";
	...
	if (pDevice == NULL)
	{
		t << "Error creating device KbfilterDevice"
			   << (ULONG) m_Unit << EOL;
	...
	{
		t << "Error constructing device KbfilterDevice"
