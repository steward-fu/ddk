// VdevOids.cpp	Definition of supported OIDs data - generated by wizard
////////////////////////////////////////////////////////////////////////////
//=============================================================================
//
...
/////////////////////////////////////////////////////////////////////////////
NDIS_OID VdevAdapter::sm_OID_GEN_SUPPORTED_LIST[] = {
...
BEGIN_OID_QUERY_MAP(VdevAdapter)
	...
	//       KNdisAdapterTraits<VdevAdapter>::IsPmAware() and 
	//		 KNdisAdapterTraits<VdevAdapter>::WakeUpExxx() attributes.
...
_inline_ NDIS_HARDWARE_STATUS VdevAdapter::getOID_GEN_HARDWARE_STATUS(void)
{
	return NdisHardwareStatusReady;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_RCV_NO_BUFFER(void)
{
	return m_GenStats->rcv_no_buffer;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_RCV_ERROR(void)
{
	return m_GenStats->rcv_error;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_RCV_OK(void)
{
	return m_GenStats->rcv_ok;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_XMIT_ERROR(void)
{
	return m_GenStats->xmit_error;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_XMIT_OK(void)
{
	return m_GenStats->xmit_ok;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_MAXIMUM_SEND_PACKETS(void)
{
	return VDEV_MAX_SEND_PACKETS;
}

_inline_ NDIS_MEDIA_STATE  VdevAdapter::getOID_GEN_MEDIA_CONNECT_STATUS(void)
{
	// TODO:	Read status form h/w
	return NdisMediaStateConnected;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_MAC_OPTIONS(void)
{
	return m_uMacOptions;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_MAXIMUM_TOTAL_SIZE(void)
{
	return VDEV_MAX_TOTAL_SIZE;
}

_inline_ USHORT VdevAdapter::getOID_GEN_DRIVER_VERSION(void)
{
	return KNdisAdapterTraits<VdevAdapter>::NdisVersion();
}

_inline_ ULONG  VdevAdapter::getOID_GEN_CURRENT_LOOKAHEAD(void)
{
	return VDEV_MAX_LOOKAHEAD;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_CURRENT_PACKET_FILTER(void)
{
	return m_uPacketFilter;
}

NDIS_STATUS  VdevAdapter::getOID_GEN_VENDOR_DESCRIPTION
	(char* pDesc, IN OUT PULONG ByteCount, OUT PULONG BytesNeeded)
{
	static char Desc[] = VDEV_VENDOR_DESCRIPTION;
...
_inline_ ULONG  VdevAdapter::getOID_GEN_VENDOR_ID(void)
{
...
_inline_ ULONG VdevAdapter::getOID_GEN_VENDOR_DRIVER_VERSION()
{
	return (VDEV_VERSION_MAJOR<<8) | VDEV_VERSION_MINOR;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_RECEIVE_BLOCK_SIZE(void)
{
	return VDEV_RECEIVE_BLOCK;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_TRANSMIT_BLOCK_SIZE(void)
{
	return VDEV_TRANSMIT_BLOCK;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_RECEIVE_BUFFER_SPACE(void)
{
	return VDEV_RX_BUFFER_SPACE;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_TRANSMIT_BUFFER_SPACE(void)
{
	return VDEV_TX_BUFFER_SPACE;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_LINK_SPEED(void)
{
	return VDEV_MAX_LINKSPEED/100;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_MAXIMUM_FRAME_SIZE(void)
{
	return VDEV_MAX_FRAMESIZE;
}

_inline_ ULONG  VdevAdapter::getOID_GEN_MAXIMUM_LOOKAHEAD(void)
{
	return VDEV_MAX_LOOKAHEAD;
}

NDIS_STATUS  VdevAdapter::getOID_GEN_MEDIA_SUPPORTED
	(NDIS_MEDIUM* pMedium, PULONG ByteCount, OUT PULONG BytesNeeded) 
{
	// supported medium
	static NDIS_MEDIUM medium[] = { VDEV_MEDIUM_TYPE };
...
NDIS_STATUS  VdevAdapter::getOID_GEN_MEDIA_IN_USE
	(NDIS_MEDIUM* pMedium, PULONG ByteCount, OUT PULONG BytesNeeded) 
{
...
NDIS_STATUS  VdevAdapter::setOID_GEN_PROTOCOL_OPTIONS(PULONG Param)
{
	m_uMacOptions = *Param;
	return NDIS_STATUS_SUCCESS;	// ignore for now
}

NDIS_STATUS  VdevAdapter::setOID_GEN_CURRENT_PACKET_FILTER(PULONG Param)
{
	m_uPacketFilter = *Param;
	return NDIS_STATUS_SUCCESS;	// ignore for now
}

NDIS_STATUS  VdevAdapter::setOID_GEN_CURRENT_LOOKAHEAD(PULONG pLookahead)
{
	...
	if (*pLookahead > VDEV_MAX_LOOKAHEAD)
...
_inline_ ULONG  VdevAdapter::getOID_802_3_XMIT_ONE_COLLISION(void)
{
	return m_MediumStats->xmit_one_collision;
}

_inline_ ULONG  VdevAdapter::getOID_802_3_XMIT_MORE_COLLISIONS(void)
{
	return m_MediumStats->xmit_more_collision;
}

_inline_ ULONG  VdevAdapter::getOID_802_3_RCV_ERROR_ALIGNMENT(void)
{
	return m_MediumStats->rcv_err_align;
}

NDIS_STATUS  VdevAdapter::getOID_802_3_MULTICAST_LIST
...
_inline_ ULONG  VdevAdapter::getOID_802_3_MAXIMUM_LIST_SIZE(void)
{
	return VDEV_802_3_MAX_LIST_SIZE;
}

_inline_ ETHERNET_ADDRESS   VdevAdapter::getOID_802_3_CURRENT_ADDRESS(void)
{
	return m_CurrentAddress;
}

_inline_ ETHERNET_ADDRESS   VdevAdapter::getOID_802_3_PERMANENT_ADDRESS(void)
{
...
NDIS_STATUS  VdevAdapter::setOID_802_3_MULTICAST_LIST
...
NDIS_STATUS VdevAdapter::getOID_PNP_QUERY_POWER(PNDIS_DEVICE_POWER_STATE DesiredState)
{
...
NDIS_STATUS VdevAdapter::setOID_PNP_SET_POWER(PNDIS_DEVICE_POWER_STATE DesiredState)
{
...
NDIS_STATUS VdevAdapter::setOID_PNP_ADD_WAKE_UP_PATTERN(PNDIS_PM_PACKET_PATTERN Pattern)
{
	...
	//		 KNdisPnpMode<VdevAdapter> policies.
...
NDIS_STATUS VdevAdapter::setOID_PNP_REMOVE_WAKE_UP_PATTERN(PNDIS_PM_PACKET_PATTERN Pattern)
{
...
ULONG VdevAdapter::getOID_PNP_ENABLE_WAKE_UP()
{
...
NDIS_STATUS VdevAdapter::setOID_PNP_ENABLE_WAKE_UP(PULONG uMask)
{
