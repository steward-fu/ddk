...
SOURCE=.\E100bexOidBrowser.h
# PROP Ignore_Default_Tool 1
# Begin Custom Build - *** This configuration exists only to allow browsing of OID handlers.
InputPath=.\E100bexOidBrowser.h

"null" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	echo *** It is not meant to be compiled, please choose a Win32 NDIS 5 Configuration in Build menu to build your driver.
