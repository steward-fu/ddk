...
#define NIC_MAX_PACKET_SIZE             MAXIMUM_ETHERNET_PACKET_SIZE
#define NIC_MIN_PACKET_SIZE             MINIMUM_ETHERNET_PACKET_SIZE
#define NIC_HEADER_SIZE                 ETHERNET_HEADER_SIZE

// multicast list size
#define NIC_MAX_MCAST_LIST              MAX_MULTICAST_ADDRESSES
...
#define CB_STATUS_UNDERRUN      BIT_12          // CB U Bit
...
typedef struct _RFD_STRUC {
	...
	static ULONG GetBufferLength()		// Required by KNdisSharedReceiveArea D::GetBufferLength()
		{ return NIC_MAX_PACKET_SIZE; }
	static ULONG GetBufferOffset()		// Required by KNdisSharedReceiveArea D::GetBufferOffset()
		{ return FIELD_OFFSET(_RFD_STRUC, RfdBuffer); }
