...
IrpIOCTL proc myQueue : WDFQUEUE, myRequest : WDFREQUEST, myOutLen : DWORD, myInLen : DWORD, myCode:DWORD
    ...
    .if myCode == IOCTL_SET
        ...
        invoke WdfRequestRetrieveInputMemory, myRequest, addr mem
        invoke WdfMemoryCopyToBuffer, mem, 0, offset szBuffer, myInLen
    ...
    .elseif myCode == IOCTL_GET
        ...
        invoke WdfRequestRetrieveOutputMemory, myRequest, addr mem
        invoke WdfMemoryCopyFromBuffer, mem, 0, offset szBuffer, myOutLen
