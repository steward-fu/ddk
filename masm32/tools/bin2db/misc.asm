...
AboutProc proc hWin:DWORD,uMsg:DWORD,wParam:DWORD,lParam:DWORD
    ...
    LOCAL rct       :RECT
      ...
      ; -------------------------------------------
          tdat db "MASM32 Bin2db Tool Version 3.0",13,10
               db "Copyright (c) The MASM32 SDK 1998-2010",13,10,13,10
               db "Open any file converting it to MASM DB format and",13,10
               db "save it as a source file for inclusion in your project.",0
          text dd tdat
