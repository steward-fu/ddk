...
* Abstract:
*
*   This module contains the definitions for the 3Dlabs P3/R3 RAMDAC
*
* Environment:
*
*   Kernel mode
...
#else    //    P3RD_REVERSE_LUT_INDEX
#define P3RD_CALCULATE_LUT_INDEX(x) (x)
#endif    //    P3RD_REVERSE_LUT_INDEX

// Check to see whether byte doubling is required. If, at 8BPP, any of the VESA horizontal 
// parameters have the bottom bit set then we need to put the chip into 
// 64-bit, byte-doubling mode.
...
// Check whether the current mode needs to be pixel doubled (i.e are we at 8BPP and
// we fufill the above criteria.
