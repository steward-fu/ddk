...
#ifndef WIN32								/* ;Internal */
    LRESULT ACMAPI acmApplicationExit(HTASK htask, LPARAM lParam);	/* ;Internal */
    BOOL ACMAPI acmHugePageLock(LPBYTE pbArea, DWORD cbBuffer, BOOL fMapped);	/* ;Internal */
    void ACMAPI acmHugePageUnlock(LPBYTE pbArea, DWORD cbBuffer, BOOL fMapped);	/* ;Internal */
#endif									/* ;Internal */
