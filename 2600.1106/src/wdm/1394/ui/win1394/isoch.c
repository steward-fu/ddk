        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    sscanf (tmpBuff, "%p", &(pIsochAttachBuffers->hResource));
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    sscanf (tmpBuff, "%p", &(pIsochDetachBuffers->hResource));
                    ...
                    sscanf (tmpBuff, "%p", &(pIsochDetachBuffers->pIsochDescriptor));
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    sscanf (tmpBuff, "%p", &(pIsochListen->hResource));
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    sscanf (tmpBuff, "%p", pIsochSetChannelBandwidth->hBandwidth);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    sscanf (tmpBuff, "%p", &(pIsochStop->hResource));
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    sscanf (tmpBuff, "%p", &(pIsochTalk->hResource));
