                ...
                if (!SharedData) {
                    ...
                    if (bCreateProcess) {
                        ...
                        bReturn = CreateProcess( NULL,
                                                 "RUNDLL32 1394API.DLL,DLL_Thread",
                                                 NULL,
                                                 NULL,
                                                 FALSE,
                                                 DETACHED_PROCESS,
...
//#ifdef CancelIO  // BUGBUG win98 DDK winbase.h is missing CancelIO def; will remove this ifdef when that is fixed
                    CancelIo(hDevice);
//#endif
                    break;
                }
