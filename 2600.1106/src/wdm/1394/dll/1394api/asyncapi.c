...
Exit_AsyncAllocateAddressRange:
    ...
    if (bAutoAlloc) {
        ...
        // copy the handle over if needed
    ...
    )
{
    ...
    if (asyncLoopbackParamsEx->bKill)
        return;
...
Exit_AsyncStreamLoopbackThread:
    ...
    // reset pass/fail iteration counts
    pStreamLoopbackParams->ulPass = 0;
    pStreamLoopbackParams->ulFail = 0;
    pStreamLoopbackParams->ulIterations = 0;
