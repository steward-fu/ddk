...
MessageId=0x0100 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_SERIAL_ACCESS_FAILED
Language=English
Access serial port failed.
.

MessageId=0x0101 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_OPEN_SERIAL_FAILED
Language=English
Open serial port failed.
.

MessageId=0x0102 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_INIT_SERIAL_FAILED
Language=English
Initialize serial port failed.
.

MessageId=0x0103 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_INIT_DIGITIZER_FAILED
Language=English
Initialize digitizer tablet failed.
.

MessageId=0x0104 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_QUERY_DEVINFO_FAILED
Language=English
Query digitizer information failed.
.

MessageId=0x0105 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_RESTORE_SERIAL_FAILED
Language=English
Restore serial port settings failed.
.

MessageId=0x0106 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_WAKE_DIGITIZER_FAILED
Language=English
Failed waking the digitizer.
.

MessageId=0x0107 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_SLEEP_DIGITIZER_FAILED
Language=English
