...
MessageId=0x0100 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_INVALID_CONFIGURATION
Language=English
The device is incorrectly configured.
.

MessageId=0x0101 Facility=ErrLog Severity=Error SymbolicName=ERRLOG_CONNECTIRQ_FAILED
Language=English
Connect to the assigned IRQ has failed (IRQ=%2).
.
