...
--*/
{
   ...
   NDIS_STATUS             Status = NDIS_STATUS_SUCCESS;
	PXMIT_SEG_INFO          pXmitSegInfo = pVc->XmitSegInfo;
   PATM_FLOW_PARAMETERS    pFlow = &pVc->Transmit;
...
#ifndef NEW_DMA
       NdisFreeSpinLock(&pXmitSegInfo->InUseMapRegisterQ.lock);
#endif
...
--*/
{
   ...
   PTX_PENDING_SLOTS_CTL       pXmitSlotDesc;
...
#ifndef NEW_DMA
       InitializeMapRegisterQueue(&pXmitSegInfo->InUseMapRegisterQ);
#endif
...
--*/
{
   ...
   ULONG                   tmpFreeSlots;
   PRECV_BUFFER_HEADER	    ptmpHeader;
   PRECV_BUFFER_HEADER	    pNextHeader;
