...
//
// Newly added for Permedia 3
//

#define     P3RD_RAMDAC         14
...
#define VideoPortReadRegisterUshort(src) (*((volatile unsigned short *) src))
#define VideoPortReadRegisterUchar(src) (*((volatile unsigned char *) src))
...
#define VideoPortReadRegisterUlong(src) (*((volatile unsigned long *)src))
