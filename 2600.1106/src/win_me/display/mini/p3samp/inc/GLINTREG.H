...
typedef struct GlintReg {
    ...
    DWORD               dwFill10[2];                            // 0x1010 - 0x1017
    volatile DWORD      LocalMemCaps                ; DWFILL;   // 1018h
    volatile DWORD      LocalMemTiming              ; DWFILL;   // 1020h
    volatile DWORD      LocalMemControl             ; DWFILL;   // 1028h
    volatile DWORD      LocalMemRefresh             ; DWFILL;   // 1030h
    volatile DWORD      LocalMemPowerDown           ; DWFILL;   // 1038h
    volatile DWORD      MemControl                  ; DWFILL;   // 0x1040 Permedia, P2 only
    DWORD               dwFill11[14];                           // 0x1048 - 0x1078
    volatile DWORD      BootAddress                 ; DWFILL;   // 0x1080 Permedia, P2 only
    DWORD               dwFill12[14];                           // 0x1088 - 0x10b8
    volatile DWORD      MemConfig                   ; DWFILL;   // 0x10c0 Permedia, P2 only
    DWORD               dwFill13[14];                           // 0x10c8 - 0x10f8
    volatile DWORD      BypassWriteMask             ; DWFILL;   // 0x1100 Permedia
    DWORD               dwFill14[14];                           // 0x1108 - 0x1138
    volatile DWORD      FramebufferWriteMask        ; DWFILL;   // 0x1140 Permedia, P2 only
    DWORD               dwFill15[14];                           // 0x1148 - 0x1178
    volatile DWORD      MClkCount                   ; DWFILL;   // 0x1180 Permedia, P2 only
    ...
    volatile DWORD      MiscControl                 ; DWFILL;   // 0x3088 P3 MiscControl Register
    // External Video Control 
    volatile DWORD      Fill4[0x4000/4 - 0x3090/4]  ;
