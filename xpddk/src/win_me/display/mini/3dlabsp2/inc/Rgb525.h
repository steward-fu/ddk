 ...
 *   This module contains definitions for the IBM RGB525 RAMDAC. 
 *
...
{ \
    red   = VideoPortReadRegisterUlong(RGB525_PAL_DATA) & 0xff;        \
    RGB525_DELAY; \
    green = VideoPortReadRegisterUlong(RGB525_PAL_DATA) & 0xff;        \
    RGB525_DELAY; \
    blue  = VideoPortReadRegisterUlong(RGB525_PAL_DATA) & 0xff;        \
    RGB525_DELAY; \
}
