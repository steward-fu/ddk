...
GDI_ExtTextOut_Intercept        
    dw      OFFSET GDI_ExtTextOut
    dw      SEG GDI_ExtTextOut
    db      "ExtTextOut",0
                                                        
GDI_ExtTextOut_InterceptCmd
    dw      INTERCEPT_VALIDATE              ; Validate
...
;-------------------------------------------------------------------------------
; GDI_ExtTextOut
;   This is a GDI bypass routine. We need to decide whether we want to 
;   process the call without involving GDI, or if we want to pass the 
;   thing to GDI.
;-------------------------------------------------------------------------------
...
; Presumabaly the window is not mapped if we havnt got any window clip 
; information.
