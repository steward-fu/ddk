...
DWORD _cdecl
vddGetCurrentAutoflip(
    DWORD                   dwDevHandle, 
    DDGETAUTOFLIPININFO    *pGetIn, 
    DDGETAUTOFLIPOUTINFO   *pGetOut)
{
    DISPDBG((
        "GLINTMVD: ** In vddGetCurrentAutoflip Context: 0x%x", 
        dwDevHandle));
...
DWORD _cdecl
vddGetPreviousAutoflip(
    DWORD                   dwDevHandle, 
    DDGETAUTOFLIPININFO    *pGetIn, 
    DDGETAUTOFLIPOUTINFO   *pGetOut)
{
    DISPDBG((
        "GLINTMVD: ** In vddGetPreviousAutoflip Context: 0x%x", 
        dwDevHandle));
...
vddLock(
    DWORD                   dwDevHandle,
    DDLOCKININFO           *pLockIn,
    DDLOCKOUTINFO          *pLockOut)
{
...
vddSetState(
    DWORD                   dwDevHandle,
    DDSTATEININFO          *pStateIn,
    DDSTATEOUTINFO         *pStateOut)
{
...
vddGetFieldPolarity(
    DWORD                   dwDevHandle,
    DDPOLARITYININFO       *pPolarityIn,
    DDPOLARITYOUTINFO      *pPolarityOut)
{
    DISPDBG((
        "GLINTMVD: ** In vddGetFieldPolarity Context: 0x%x", 
        dwDevHandle));
