del main.sys
"c:\wdf\bin\x86\x86\cl.exe" -nologo -I"c:\wdf\inc\wdf\kmdf\1.9" -I"c:\wdf\inc\ddk" -I"c:\wdf\inc\api" -D_X86_ /c /Zl /Gz /DKMDF_MAJOR_VERSION=1 /DKMDF_MINOR_VERSION=9 /DKMDF_MAJOR_VERSION_STRING=01 /DKMDF_MINOR_VERSION_STRING=009 main.c
