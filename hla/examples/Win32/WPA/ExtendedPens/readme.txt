...
------------------------------------------------
Standard Build via make.exe: ExtendedPens.rap
...
------------------------------------------------
Build via nmake.exe: ExtendedPens_nmake.rap
...
------------------------------------------------
Batch Files: ExtendedPens_bat.rap

The CopyModes_bat.rap file invokes batch files
