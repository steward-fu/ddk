...
------------------------------------------------
Standard Build via make.exe: Polygons.rap
...
------------------------------------------------
Build via nmake.exe: Polygons_nmake.rap
...
------------------------------------------------
Batch Files: Polygons_bat.rap

The Polygons_bat.rap file invokes batch files
