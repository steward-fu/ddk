...
------------------------------------------------
Standard Build via make.exe: kbsysmet.rap
...
------------------------------------------------
Build via nmake.exe: kbsysmet_nmake.rap
...
------------------------------------------------
Batch Files: kbsysmet_bat.rap

The kbSysmetbat.rap file invokes batch files
