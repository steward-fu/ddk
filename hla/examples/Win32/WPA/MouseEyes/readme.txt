...
------------------------------------------------
Standard Build via make.exe: MouseEyes.rap
...
------------------------------------------------
Build via nmake.exe: MouseEyes_nmake.rap
...
------------------------------------------------
Batch Files: MouseEyes_bat.rap

The MouseEyes_bat.rap file invokes batch files
