...
------------------------------------------------
Standard Build via make.exe: TextAttr.rap
...
------------------------------------------------
Build via nmake.exe: TextAttr_nmake.rap
...
------------------------------------------------
Batch Files: TextAttr_bat.rap

The TextAttr_bat.rap file invokes batch files
