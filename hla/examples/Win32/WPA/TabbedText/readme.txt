...
------------------------------------------------
Standard Build via make.exe: TabbedText.rap
...
------------------------------------------------
Build via nmake.exe: TabbedText_nmake.rap
...
------------------------------------------------
Batch Files: TabbedText_bat.rap

The TabbedText_bat.rap file invokes batch files
