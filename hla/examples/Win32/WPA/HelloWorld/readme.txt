...
------------------------------------------------
Standard Build via make.exe: HelloWorld.rap
...
------------------------------------------------
Build via nmake.exe: HelloWorld_nmake.rap
...
------------------------------------------------
Batch Files: HelloWorld_bat.rap

The GDCaps_bat.rap file invokes batch files
