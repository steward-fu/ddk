...
------------------------------------------------
Standard Build via make.exe: ConsoleHello.rap
...
------------------------------------------------
Build via nmake.exe: ConsoleHello_nmake.rap
...
------------------------------------------------
Batch Files: ConsoleHello_bat.rap

The ConsoleHello_bat.rap file invokes batch files
