...
------------------------------------------------
Standard Build via make.exe: MousePts.rap
...
------------------------------------------------
Build via nmake.exe: MousePts_nmake.rap
...
------------------------------------------------
Batch Files: MousePts_bat.rap

The MousePts_bat.rap file invokes batch files
