...
------------------------------------------------
Standard Build via make.exe: MouseCapture.rap
...
------------------------------------------------
Build via nmake.exe: MouseCapture_nmake.rap
...
------------------------------------------------
Batch Files: MouseCapture_bat.rap

The MouseCapture_bat.rap file invokes batch files
