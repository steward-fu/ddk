...
------------------------------------------------
Standard Build via make.exe: Metafiles.rap
...
------------------------------------------------
Build via nmake.exe: Metafiles_nmake.rap
...
------------------------------------------------
Batch Files: Metafiles_bat.rap

The Metafiles_bat.rap file invokes batch files
