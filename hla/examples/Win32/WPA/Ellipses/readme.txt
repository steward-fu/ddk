...
------------------------------------------------
Standard Build via make.exe: Ellipses.rap
...
------------------------------------------------
Build via nmake.exe: Ellipses_nmake.rap
...
------------------------------------------------
Batch Files: Ellipses_bat.rap

The Ellipses_bat.rap file invokes batch files
