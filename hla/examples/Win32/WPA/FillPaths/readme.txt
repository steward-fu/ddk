...
------------------------------------------------
Standard Build via make.exe: FillPaths.rap
...
------------------------------------------------
Build via nmake.exe: FillPaths_nmake.rap
...
------------------------------------------------
Batch Files: FillPaths_bat.rap

The FillPaths_bat.rap file invokes batch files
