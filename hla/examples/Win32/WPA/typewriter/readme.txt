...
------------------------------------------------
Standard Build via make.exe: typewriter.rap
...
------------------------------------------------
Build via nmake.exe: typewriter_nmake.rap
...
------------------------------------------------
Batch Files: typewriter_bat.rap

The typewriter_bat.rap file invokes batch files
