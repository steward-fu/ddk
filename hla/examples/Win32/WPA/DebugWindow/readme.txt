...
------------------------------------------------
Standard Build via make.exe: DebugWindow.rap
...
------------------------------------------------
Build via nmake.exe: DebugWindow_nmake.rap
...
------------------------------------------------
Batch Files: DebugWindow_bat.rap

The DebugWindow_bat.rap file invokes batch files
