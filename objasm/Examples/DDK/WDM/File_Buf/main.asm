...
Object MyDevice, , KPnpDevice
    ...
    DefineVariable Buffer, BYTE, 255 dup(0)
ObjectEnd
...
Method MyDevice.Read, uses esi, I : PKIrp
    ...
    SetObject esi
    OCall I::KIrp.BufferedReadDest
    mov pBuffer, eax

    invoke strcpy, pBuffer, addr [esi].Buffer
...
Method MyDevice.Write, uses esi, I : PKIrp
    ...
    OCall I::KIrp.BufferedWriteSource
    mov pBuffer, eax

    invoke strcpy, addr [esi].Buffer, pBuffer
