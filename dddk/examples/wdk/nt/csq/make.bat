...
if exist main.obj (
    ...
    c:\dddk\bin\link.exe /NOLOGO /ALIGN:32 /BASE:0x10000 /SUBSYSTEM:NATIVE /DRIVER /FORCE:UNRESOLVED /FORCE:MULTIPLE /ENTRY:DriverEntry c:\dddk\inc\DDDK.obj c:\masm32\lib\wxp\i386\ntoskrnl.lib main.obj /out:main.sys
    del /s /q main.dcu
    del /s /q main.obj
)
